...
export default function Index() {
  return (
    <View className="flex flex-col w-screen bg-[#f5f4f8] h-screen p-4 gap-8">
      <View className="flex flex-row justify-between w-full items-center">
        <FontAwesome size={48} name="circle" color="black" />
        <View className="flex flex-col justify-center items-center">
          <Text className="text-3xl text-[#404040]">
            matema<Text className="font-extrabold">tecAR</Text>
          </Text>
      ...
      <Card className="bg-[#0079c2] py-[48px]">
        <View className="flex-1 flex flex-col items-center justify-center gap-4">
          <View className="flex flex-col items-center">
            <Text className="text-[100px] font-extrabold text-white leading-none">
              AR
            </Text>
      ...
      <Section>
        ...
        <NavButton href="/tutorial" className="w-full bg-[#7ac142]">
        ...
        <View className="flex flex-row gap-4">
          <Link href="https://matemateca.ime.usp.br/">
            <Card className="bg-[#eaaa08] w-fit flex flex-col gap-4">
              <FontAwesome size={100} name="cube" color="white" />
              <Text className="text-[16px] font-extrabold text-white leading-none">
                Matemateca
              </Text>
            </Card>
          </Link>
